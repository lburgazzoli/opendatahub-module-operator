...
import (
	...
	platform "github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-spark-operator/pkg/platform"
	...
	mgrOpts := ctrl.Options{
		...
		Cache: cache.Options{
			...
			ByObject: map[client.Object]cache.ByObject{
				&componentsv1alpha1.SparkOperator{}:         {Label: k8slabels.Everything()},
