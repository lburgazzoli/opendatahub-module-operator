...
import (
	...
	libcache "github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-spark-operator/pkg/cache"
...
func run(cmd *cobra.Command, _ []string) error {
	...
	if err := sparkoperator.NewReconciler(cmd.Context(), mgr, cfg, rel); err != nil {
		return fmt.Errorf("creating sparkoperator reconciler: %w", err)
	}
