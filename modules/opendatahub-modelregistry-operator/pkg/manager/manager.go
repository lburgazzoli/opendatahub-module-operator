...
import (
	...
	platform "github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-modelregistry-operator/pkg/platform"
	...
	mgrOpts := ctrl.Options{
		...
		Cache: cache.Options{
			...
			ByObject: map[client.Object]cache.ByObject{
				&componentsv1alpha1.ModelRegistry{}:         {Label: k8slabels.Everything()},
