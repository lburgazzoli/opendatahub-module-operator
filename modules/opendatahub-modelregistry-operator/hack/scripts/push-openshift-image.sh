...
Push a locally built image to the OpenShift internal registry and print the
...
registry_route_name="${OCP_REGISTRY_ROUTE_NAME:-default-route}"
registry_route_namespace="${OCP_REGISTRY_ROUTE_NAMESPACE:-openshift-image-registry}"
...
internal_image="${internal_registry_host}/${image_namespace}/${image_name}:${ocp_tag}"
