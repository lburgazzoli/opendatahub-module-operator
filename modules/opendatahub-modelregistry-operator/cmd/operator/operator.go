...
import (
	...
	"github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-modelregistry-operator/internal/controller/modelregistry"
	libcache "github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-modelregistry-operator/pkg/cache"
...
func run(cmd *cobra.Command, _ []string) error {
	...
	if err := modelregistry.NewReconciler(cmd.Context(), mgr, cfg, rel); err != nil {
		return fmt.Errorf("creating modelregistry reconciler: %w", err)
	}
