...
const (
	...
	KeyWebhookEnabled     = "controller.webhook.enabled"
	...
	DefaultLeaderElectID      = "opendatahub-mymodule-operator-lock"
...
// the "controller." prefix (e.g. "controller.leader-elect").
type Config struct {
...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault(KeyWebhookEnabled, DefaultWebhookEnabled)
