...
import (
	...
	"github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-mymodule-operator/pkg/resources/gvk"
)

const (
	defaultOutputDir   = "config/chart"
	defaultChartName   = "opendatahub-mymodule-operator"
