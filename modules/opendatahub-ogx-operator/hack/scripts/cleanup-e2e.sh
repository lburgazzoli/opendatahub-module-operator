...
NAMESPACE="${1:-opendatahub-ogx-operator-system}"
HELM_RELEASE="${2:-opendatahub-ogx-operator}"
...
kubectl delete clusterroles -l platform.opendatahub.io/part-of=ogx --ignore-not-found 2>/dev/null || true
kubectl delete clusterrolebindings -l platform.opendatahub.io/part-of=ogx --ignore-not-found 2>/dev/null || true
