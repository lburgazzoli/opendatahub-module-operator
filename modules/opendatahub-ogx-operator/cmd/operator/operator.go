...
import (
	...
	libcache "github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-ogx-operator/pkg/cache"
...
func run(cmd *cobra.Command, _ []string) error {
	...
	if err := ogx.NewReconciler(cmd.Context(), mgr, cfg, rel); err != nil {
		return fmt.Errorf("creating ogx reconciler: %w", err)
	}
