...
import (
	...
	modulemanager "github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-ogx-operator/pkg/manager"
...
func runTestMain(m *testing.M) int {
	...
	if err := cli.Get(ctx, client.ObjectKeyFromObject(moduleCRD), moduleCRD); err != nil {
		fmt.Fprintf(
			...
			componentsv1alpha1.OGXCRDName,
			err,
		)
		return 1
	}

	_ = cli.DeleteAllOf(ctx, &componentsv1alpha1.OGX{})
