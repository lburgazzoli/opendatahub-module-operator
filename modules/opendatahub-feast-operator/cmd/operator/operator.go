...
import (
	...
	libcache "github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-feast-operator/pkg/cache"
...
func run(cmd *cobra.Command, _ []string) error {
	...
	if err := feastoperator.NewReconciler(cmd.Context(), mgr, cfg, rel); err != nil {
		return fmt.Errorf("creating feastoperator reconciler: %w", err)
	}
