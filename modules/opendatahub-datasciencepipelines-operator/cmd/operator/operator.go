...
import (
	...
	libcache "github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-datasciencepipelines-operator/pkg/cache"
...
func run(cmd *cobra.Command, _ []string) error {
	...
	if err := datasciencepipelines.NewReconciler(cmd.Context(), mgr, cfg, rel); err != nil {
		return fmt.Errorf("creating datasciencepipelines reconciler: %w", err)
	}
