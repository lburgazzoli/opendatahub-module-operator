...
import (
	...
	"github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-datasciencepipelines-operator/internal/controller/datasciencepipelines"
	...
	platform "github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-datasciencepipelines-operator/pkg/platform"
...
func New(
	...
	mgrOpts := ctrl.Options{
		...
		Cache: cache.Options{
			...
			ByObject: map[client.Object]cache.ByObject{
				&componentsv1alpha1.DataSciencePipelines{}:  {Label: k8slabels.Everything()},
	...
	if err := datasciencepipelines.NewReconciler(ctx, mgr, cfg, cfg.Release()); err != nil {
		return nil, fmt.Errorf("creating datasciencepipelines reconciler: %w", err)
	}
