...
func newTestRR(t *testing.T, obj *componentApi.Trainer) *odhtypes.ReconciliationRequest {
	t.Helper()
...
func newTestTrainer() *componentApi.Trainer {
...
func TestNewModule(t *testing.T) {
	...
	g.Expect(m.variant.Kustomize[0].ManifestInfo.SourcePath).To(Equal("rhoai"))
}
...
func TestStageManifests(t *testing.T) {
	...
	g.Expect(rr.Manifests[0].SourcePath).To(Equal("rhoai"))
