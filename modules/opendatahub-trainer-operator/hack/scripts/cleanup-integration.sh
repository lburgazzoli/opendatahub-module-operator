...
NAMESPACE="${1:-${HELM_NAMESPACE:-opendatahub-trainer-operator-system}}"
...
kubectl delete clusterroles -l platform.opendatahub.io/part-of=trainer --ignore-not-found 2>/dev/null || true
kubectl delete clusterrolebindings -l platform.opendatahub.io/part-of=trainer --ignore-not-found 2>/dev/null || true
kubectl delete jobsetoperators.operator.openshift.io -l "${STUB_LABEL}" --ignore-not-found 2>/dev/null || true
kubectl delete crd -l "${STUB_LABEL}" --ignore-not-found 2>/dev/null || true
