...
#   KIND_CLUSTER         - cluster name (default: opendatahub-trainer-operator)
...
CLUSTER="${1:-${KIND_CLUSTER:-opendatahub-trainer-operator}}"
...
# Install external CRDs (e.g. OpenShift SCC) required for testing
