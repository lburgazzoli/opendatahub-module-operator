...
import (
	...
	libcache "github.com/lburgazzoli/opendatahub-module-operator/modules/opendatahub-trustyai-operator/pkg/cache"
...
func run(cmd *cobra.Command, _ []string) error {
	...
	if err := trustyai.NewReconciler(cmd.Context(), mgr, cfg, rel); err != nil {
		return fmt.Errorf("creating trustyai reconciler: %w", err)
	}
