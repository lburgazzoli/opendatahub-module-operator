...
NAMESPACE="${1:-opendatahub-trustyai-integration}"
...
kubectl delete clusterroles -l platform.opendatahub.io/part-of=trustyai --ignore-not-found 2>/dev/null || true
kubectl delete clusterrolebindings -l platform.opendatahub.io/part-of=trustyai --ignore-not-found 2>/dev/null || true
